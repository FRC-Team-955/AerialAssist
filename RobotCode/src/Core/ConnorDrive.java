...
public class ConnorDrive {
    ...
    MyTalon right1 = new MyTalon(Config.chnRight1);
    MyTalon right2 = new MyTalon(Config.chnRight2);
    MyTalon right3 = new MyTalon(Config.chnRight3);
